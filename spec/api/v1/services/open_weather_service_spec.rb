...
RSpec.describe OpenWeatherService, type: :model do
  describe "class methods" do
    it "#get_weather", :vcr do
      ...
      expect(response[:hourly].first.keys).to eq([:dt, :temp, :feels_like, :pressure, :humidity, :dew_point, :uvi, :clouds, :visibility, :wind_speed, :wind_deg, :wind_gust, :weather, :pop, :rain])
